...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-secondary-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md">
        ...
        <!-- Login Card -->
        <div class="card" x-data="{ loading: false, showPassword: false }">
            <h2 class="text-2xl font-display font-bold text-gray-900 mb-6">Welcome Back</h2>
            ...
            <form action="<?= site_url('auth/login') ?>" method="POST" class="space-y-4" @submit="loading = true">
                <?= csrf_field() ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?= site_url('auth/forgot-password') ?>" class="text-sm font-medium text-primary-600 hover:text-primary-700">
                        Forgot password?
                    </a>
                </div>
